...
import com.kuangjia.main.utils.UploadUtil;

import java.util.HashMap;
import java.util.Map;

public class UploadPictureActivity extends Activity implements View.OnClickListener,UploadUtil.OnUploadProcessListener {
