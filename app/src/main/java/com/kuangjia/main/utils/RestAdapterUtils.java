package com.kuangjia.main.utils;

import android.content.Context;

import com.kuangjia.main.kjapplication.MyApplication;
...
public class RestAdapterUtils {
    ...
    public static <T> T getRestAPI(String endpoint, final Class<T> service) {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder()
                ...
                .setRequestInterceptor(new RequestInterceptor(){
                    @Override
                    public void intercept(RequestFacade request) {
                        request.addQueryParam("deviceid",DeviceUtils.getIEMI(MyApplication.getInstance()));
                    }
                })
    ...
    public static <T> T getRestAPI1(String endpoint, final Class<T> service){
